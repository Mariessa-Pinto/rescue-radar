...
const QuizContainer = () => {
  ...
  return (
    <div className={`md:w-full mb-20 flex flex-col items-center lg:pb-10 lg:w-9/12 lg:rounded-lg lg:bg-white`}>
      <div data-testid="quizCon" className={`md:w-full flex flex-col justify-center items-center mb-4`}>
