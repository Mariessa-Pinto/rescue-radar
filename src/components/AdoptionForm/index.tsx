...
const AdoptionForm = ({ dog, onClose }: IAdoptDogProps) => {
    ...
    return (
        <main>
            ...
            <div className={`flex flex-col items-center justify-between `}>
                ...
                <button className="absolute top-2 md:right-4 lg:right-64 lg:top-10 right-2 text-black font-outfit font-outfit text-h1 font-extrabold" onClick={onClose}>
                    X
                </button>
